...
#ifndef EUREKA_STEERING_LIBRARY__EUREKA_STEERING_LIBRARY_HPP_
#define EUREKA_STEERING_LIBRARY__EUREKA_STEERING_LIBRARY_HPP_
...
#include "eureka_steering_library/steering_odometry.hpp"
#include "eureka_steering_library/visibility_control.h"
#include "eureka_steering_library_parameters.hpp"

// TODO(anyone): Replace with controller specific messages
#include "ackermann_msgs/msg/ackermann_drive_stamped.hpp"
#include "eureka_control_msgs/msg/steering_controller_status.hpp"
...
{
public:
  EUREKA_STEERING__VISIBILITY_PUBLIC EurekaSteeringLibrary();

  virtual EUREKA_STEERING__VISIBILITY_PUBLIC void
  initialize_implementation_parameter_listener() = 0;

  EUREKA_STEERING__VISIBILITY_PUBLIC controller_interface::CallbackReturn on_init() override;

  EUREKA_STEERING__VISIBILITY_PUBLIC controller_interface::InterfaceConfiguration
  command_interface_configuration() const override;

  EUREKA_STEERING__VISIBILITY_PUBLIC controller_interface::InterfaceConfiguration
  state_interface_configuration() const override;

  virtual EUREKA_STEERING__VISIBILITY_PUBLIC controller_interface::CallbackReturn
  configure_odometry() = 0;

  virtual EUREKA_STEERING__VISIBILITY_PUBLIC bool update_odometry(
    const rclcpp::Duration & period) = 0;

  EUREKA_STEERING__VISIBILITY_PUBLIC controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override;

  EUREKA_STEERING__VISIBILITY_PUBLIC controller_interface::CallbackReturn on_activate(
    const rclcpp_lifecycle::State & previous_state) override;

  EUREKA_STEERING__VISIBILITY_PUBLIC controller_interface::CallbackReturn on_deactivate(
    const rclcpp_lifecycle::State & previous_state) override;

  EUREKA_STEERING__VISIBILITY_PUBLIC controller_interface::return_type
  ...
  using AckermanControllerState = eureka_control_msgs::msg::SteeringControllerStatus;

protected:
  controller_interface::CallbackReturn set_interface_numbers(
    size_t nr_state_itfs, size_t nr_cmd_itfs, size_t nr_ref_itfs);

  std::shared_ptr<eureka_steering_library::ParamListener> param_listener_;
  eureka_steering_library::Params params_;
...
private:
  ...
  EUREKA_STEERING__VISIBILITY_LOCAL void reference_callback(
...
#endif  // EUREKA_STEERING_LIBRARY__EUREKA_STEERING_LIBRARY_HPP_
