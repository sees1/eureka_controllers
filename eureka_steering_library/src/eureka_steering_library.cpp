...
using ControllerTwistReferenceMsg =
  eureka_steering_library::EurekaSteeringLibrary::ControllerTwistReferenceMsg;
...
{
EurekaSteeringLibrary::EurekaSteeringLibrary()
: controller_interface::ChainableControllerInterface()
{
}

controller_interface::CallbackReturn EurekaSteeringLibrary::on_init()
{
  try
  {
    param_listener_ = std::make_shared<eureka_steering_library::ParamListener>(get_node());
...
controller_interface::CallbackReturn EurekaSteeringLibrary::set_interface_numbers(
...
controller_interface::CallbackReturn EurekaSteeringLibrary::on_configure(
...
void EurekaSteeringLibrary::reference_callback(
  const std::shared_ptr<ControllerTwistReferenceMsg> msg)
{
...
EurekaSteeringLibrary::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
EurekaSteeringLibrary::state_interface_configuration() const
{
...
EurekaSteeringLibrary::on_export_reference_interfaces()
{
...
bool EurekaSteeringLibrary::on_set_chained_mode(bool chained_mode)
{
  // Always accept switch to/from chained mode
  return true || chained_mode;
}

controller_interface::CallbackReturn EurekaSteeringLibrary::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::CallbackReturn EurekaSteeringLibrary::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::return_type EurekaSteeringLibrary::update_reference_from_subscribers()
{
...
controller_interface::return_type EurekaSteeringLibrary::update_and_write_commands(
